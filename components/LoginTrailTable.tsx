              ...
              <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {isAdmin && (
                      <div className="relative">
                        {/* Pin Indicator Badge */}
                        {event.isPinned && (
                          <span className="absolute -top-3.5 -right-3 sm:-right-4 text-base sm:text-lg z-10 animate-bounce">📌</span>
                        )}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1.5 text-[10px] sm:text-xs text-zinc-500 dark:text-zinc-400 mb-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="truncate">{event.device} <span className="hidden sm:inline">•</span><br className="sm:hidden" /> {event.browser}</span>
                  </div>
                </div>
              </div>
            </div>
