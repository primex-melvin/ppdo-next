...
import { BudgetParticularCombobox } from "@/components/ppdo/11_project_plan/components/BudgetParticularCombobox";
        ...
        <div className="pt-2 space-y-3">
          <div className="flex items-center justify-between">
            <Button
              ...
              // 🆕 Disable manual input toggle when auto-calculate is ON
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            placeholder="0"
                            // 🆕 Disable input when auto-calculate is ON
                            disabled={autoCalculate === true}
