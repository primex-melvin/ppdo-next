...
/**
 * Note: BudgetAvailabilityResult is exported from @/components/ppdo/common/utils
 * to keep the type with its primary implementation.
 * 
 * Import it from:
 * import type { BudgetAvailabilityResult } from "@/components/ppdo/common/utils";
 * or
 * import type { BudgetAvailabilityResult } from "@/components/ppdo/common";
 */
...
// @/components/ppdo/common/components/modals to avoid circular dependencies
// and keep modal-related types with their components.
//
// Import them from:
// import type { ViolationData, ViolationDetail } from "@/components/ppdo/common/components/modals";
// or
// import type { ViolationData, ViolationDetail } from "@/components/ppdo/common";
