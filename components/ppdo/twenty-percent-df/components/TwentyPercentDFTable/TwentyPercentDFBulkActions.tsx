...
interface TwentyPercentDFBulkActionsProps {
 ...
 */
export function TwentyPercentDFBulkActions({
    selectedCount,
    onCategoryChange,
}: TwentyPercentDFBulkActionsProps) {
                        ...
                        <div className="w-[300px] p-4 gap-4 flex flex-col bg-white dark:bg-zinc-950">
                            <div className="space-y-3">
                                ...
                                <p className="text-xs text-zinc-500">
                                    Select a new category to move all selected items:
                                </p>
