...
interface TwentyPercentDFBulkToggleDialogProps {
    isOpen: boolean;
    onClose: () => void;
...
export function TwentyPercentDFBulkToggleDialog({
    isOpen,
    onClose,
    onConfirm,
    selectedCount,
    isLoading = false,
}: TwentyPercentDFBulkToggleDialogProps) {
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update auto-calculation settings for {selectedCount} selected project{selectedCount !== 1 ? 's' : ''}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/50 rounded-lg">
                        ...
                        <div className="text-xs text-blue-700 dark:text-blue-300">
                            ...
                            <ul className="mt-1 space-y-1 list-disc list-inside">
                                {autoCalculate ? (
                                    <>
                                        <li>Budget utilized will be automatically calculated from child breakdowns</li>
                                    ...
                                    <>
                                        ...
                                        <li>Automatic calculation from breakdowns will be disabled</li>
                                        <li>Status counts and obligated budget remain automatic</li>
                                    </>
                                )}
                            </ul>
                ...
                <DialogFooter>
                    ...
                    >
                        {isLoading ? "Updating..." : `Update ${selectedCount} Project${selectedCount !== 1 ? 's' : ''}`}
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
