...
import {
  ...
  getMaxTableWidth,
} from '@/components/features/ppdo/odpp/utilities/table/print-preview/table-resize/constants';
import {
  ResizingColumnState,
  ResizingRowState,
  HoveredHandle,
...
} from '@/components/features/ppdo/odpp/utilities/table/print-preview/table-resize/types';
