...
/**
 * BudgetViolationModal - Unified Modal Component
 * 
 * Displays budget allocation and utilization violation warnings.
 * Supports multi-step flow (allocation → utilization warnings).
 * 
 * @example
 ...
 *   allocationViolation={allocationViolation}
 *   utilizationViolation={utilizationViolation}
 * />
 */
...
export interface BudgetViolationModalProps {
    ...
    onClose: () => void;
    /** Callback when user confirms to proceed despite violations */
    onConfirm: () => void;
    /** Allocation violation data */
    allocationViolation: ViolationData;
    /** Utilization violation data */
