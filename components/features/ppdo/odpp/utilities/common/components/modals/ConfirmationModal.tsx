...
/**
 * ConfirmationModal - Unified Modal Component
 * 
...
export interface ConfirmationModalProps {
    ...
    isOpen: boolean;
    /** Callback when modal is closed (backdrop click or cancel) */
    onClose: () => void;
    /** Callback when confirm button is clicked */
    onConfirm: () => void;
    /** Optional callback when cancel button is clicked (separate from onClose) */
    onCancel?: () => void;
    /** Modal title */
    title: string;
