...
function BudgetResizableTotalsRow({ columns, budgetItems }: BudgetResizableTotalsRowProps) {
    ...
    return (
        <tr className="sticky bottom-0 bg-zinc-50 dark:bg-zinc-800 font-bold z-20 shadow-[0_-1px_0_0_rgba(0,0,0,0.1)] dark:shadow-[0_-1px_0_0_rgba(255,255,255,0.1)]">
            <td className="text-center py-2" style={{ border: "1px solid var(--border)" }} />
            <td className="text-center py-2 text-[11px] sm:text-xs text-zinc-700 dark:text-zinc-200" style={{ border: "1px solid var(--border)" }} />
            {columns.map(column => {
                ...
                return (
                    <td
                        ...
                        style={{ border: "1px solid var(--border)", textAlign: column.align }}
                    >
                        {cellContent}
                    </td>
                );
            })}
            <td className="text-center" style={{ border: "1px solid var(--border)" }} />
        </tr>
    );
}
