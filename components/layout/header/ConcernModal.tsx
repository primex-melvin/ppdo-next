...
const BugReportForm = dynamic(() => import("@/components/features/maintenance/BugReportForm").then(mod => mod.BugReportForm), {
    loading: () => <div className="flex justify-center p-8"><Loader2 className="animate-spin w-8 h-8 opacity-50" /></div>
});

const SuggestionForm = dynamic(() => import("@/components/features/maintenance/SuggestionForm").then(mod => mod.SuggestionForm), {
    loading: () => <div className="flex justify-center p-8"><Loader2 className="animate-spin w-8 h-8 opacity-50" /></div>
});
