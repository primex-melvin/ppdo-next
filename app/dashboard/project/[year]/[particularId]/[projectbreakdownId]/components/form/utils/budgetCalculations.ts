// app/dashboard/project/[year]/[particularId]/[projectbreakdownId]/components/form/utils/budgetCalculations.ts
...
export const calculateBudgetAvailability = (
  ...
  const parentTotal = parentProject.totalBudgetAllocated || 0;
