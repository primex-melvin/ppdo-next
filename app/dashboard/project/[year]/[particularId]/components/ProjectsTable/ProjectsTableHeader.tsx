// app/dashboard/project/budget/[particularId]/components/ProjectsTable/ProjectsTableHeader.tsx
      ...
      <tr className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950">
        ...
        {AVAILABLE_COLUMNS.map((column) => {
          ...
          return (
            <th
              key={column.id}
              className={`px-3 py-3 sticky top-0 bg-zinc-50 dark:bg-zinc-950 z-10 ${
