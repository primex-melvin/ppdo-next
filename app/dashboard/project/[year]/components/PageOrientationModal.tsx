// app/dashboard/project/[year]/components/PageOrientationModal.tsx
...
interface PageOrientationModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function PageOrientationModal({
  isOpen,
  onClose,
  onSelectOrientation,
  ...
  const handleConfirm = () => {
    ...
    // Modal will be closed by parent component (PrintPreviewModal)
  };
                  ...
                  <div className="relative w-full h-full max-w-[140px] max-h-[200px]">
                    ...
                    <div className="absolute inset-0 bg-white dark:bg-stone-950 rounded-lg shadow-2xl border border-stone-200 dark:border-stone-700 flex flex-col p-3">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <div className="h-1 bg-stone-200 dark:bg-stone-700 rounded w-full"></div>
                        <div className="h-1 bg-stone-200 dark:bg-stone-700 rounded w-3/4"></div>
                      </div>
                      {/* Footer */}
                      <div className="h-1 bg-stone-300 dark:bg-stone-600 rounded w-1/3 mt-2"></div>
                    </div>
                    {/* Shadow effect */}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-5 h-7 border-2 rounded-sm transition-colors ${
                          selectedOrientation === 'portrait'
                            ? 'border-white'
              ...
              >
                  ...
                  <div className="relative w-full h-full max-w-[200px] max-h-[140px]">
                    ...
                    <div className="absolute inset-0 bg-white dark:bg-stone-950 rounded-lg shadow-2xl border border-stone-200 dark:border-stone-700 flex flex-col p-3">
                      ...
                      <div className="space-y-1.5 mb-2">
                        ...
                        <div className="h-1.5 bg-stone-300 dark:bg-stone-600 rounded w-1/3"></div>
                      </div>
                      {/* Content in columns */}
                      ...
                      {/* Footer */}
                      <div className="h-1 bg-stone-300 dark:bg-stone-600 rounded w-1/4 mt-2"></div>
                    </div>
                    {/* Shadow effect */}
                    <div className="absolute inset-0 rounded-lg shadow-inner pointer-events-none"></div>
                  </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-7 h-5 border-2 rounded-sm transition-colors ${
                          selectedOrientation === 'landscape'
                            ? 'border-white'
                            : 'border-stone-400 dark:border-stone-500'
                        }`}
        ...
        <ResizableModalFooter className="px-8 py-4 bg-stone-50 dark:bg-stone-800/50">
          <div className="flex items-center justify-between w-full">
            ...
            >
              ...
              Continue with {selectedOrientation === 'portrait' ? 'Portrait' : 'Landscape'}
            </Button>
          </div>
        </ResizableModalFooter>
      </ResizableModalContent>
