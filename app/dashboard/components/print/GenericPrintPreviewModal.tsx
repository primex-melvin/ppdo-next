...
import { TemplateSelector } from '@/components/ppdo/table/print-preview/TemplateSelector';
import { TemplateApplicationModal } from '@/components/ppdo/table/print-preview/TemplateApplicationModal';
import { ColumnVisibilityPanel } from '@/components/ppdo/table/print-preview/ColumnVisibilityPanel';
...
export function GenericPrintPreviewModal({
  ...
  // 🎨 Initialize canvas from data with optional template and orientation
