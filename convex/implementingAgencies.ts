...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const agencyId = await ctx.db.insert("implementingAgencies", {
      ...
      locationFormattedAddress: args.locationFormattedAddress,
      locationBarangay: args.locationBarangay,
      locationMunicipality: args.locationMunicipality,
      locationProvince: args.locationProvince,
...
export const update = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.id, {
      ...
      ...(args.locationLatitude !== undefined && { locationLatitude: args.locationLatitude }),
      ...(args.locationLongitude !== undefined && { locationLongitude: args.locationLongitude }),
      ...(args.locationFormattedAddress !== undefined && { locationFormattedAddress: args.locationFormattedAddress }),
      ...(args.locationBarangay !== undefined && { locationBarangay: args.locationBarangay }),
      ...(args.locationMunicipality !== undefined && { locationMunicipality: args.locationMunicipality }),
      ...(args.locationProvince !== undefined && { locationProvince: args.locationProvince }),
      ...(args.locationPostalCode !== undefined && { locationPostalCode: args.locationPostalCode }),
