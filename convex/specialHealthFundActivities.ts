...
/**
 * Get activity log for a specific special health fund
 * Used by ActivityLogSheet component when viewing individual special health fund
 */
export const getBySpecialHealthFundId = query({
    args: {
    ...
    handler: async (ctx, args) => {
        ...
        const activities = await ctx.db
            .query("specialHealthFundActivities")
...
/**
 * Get all special health fund activities (for the main Special Health Funds page)
