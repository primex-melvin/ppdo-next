// convex/specialHealthFundRemarks.ts
...
/**
 * Create a new special health fund remark
 */
export const createRemark = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Verify special health fund exists
    const fund = await ctx.db.get(args.specialHealthFundId);
    if (!fund) {
    ...
    const remarkId = await ctx.db.insert("specialHealthFundRemarks", {
...
export const updateRemark = mutation({
  args: {
    remarkId: v.id("specialHealthFundRemarks"),
...
export const getRemark = query({
  ...
  handler: async (ctx, args) => {
    ...
    // Get related data
    const fund = await ctx.db.get(remark.specialHealthFundId);
...
/**
 * List all remarks for a special health fund
 */
export const listRemarksByFund = query({
  ...
  handler: async (ctx, args) => {
    let remarksQuery = ctx.db
      .query("specialHealthFundRemarks")
...
export const searchRemarks = query({
  ...
  handler: async (ctx, args) => {
    ...
    let remarks;
    if (args.specialHealthFundId !== undefined) {
      ...
      remarks = await ctx.db.query("specialHealthFundRemarks").collect();
    }
