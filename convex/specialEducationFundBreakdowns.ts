/**
 * Special Education Fund Breakdowns API
 *
 * CRUD operations for Special Education Fund breakdown records.
 ...
 *
 * @module convex/specialEducationFundBreakdowns
 */
...
/**
 * Get a single Special Education Fund Breakdown by ID
 */
export const getBreakdown = query({
  args: { id: v.id("specialEducationFundBreakdowns") },
...
/**
 * Get all active Special Education Fund Breakdowns for a specific Special Education Fund
 */
...
/**
 * Get breakdown statistics for a Special Education Fund
 */
...
export const getTrash = query({
  ...
  handler: async (ctx, args) => {
    ...
    // Filter by special education fund if specified
    if (args.specialEducationFundId) {
      return trashed.filter((b) => b.specialEducationFundId === args.specialEducationFundId);
    }
...
/**
 * Create a new Special Education Fund Breakdown
 */
export const createBreakdown = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Validate Special Education Fund exists
    const specialEducationFund = await ctx.db.get(args.specialEducationFundId);
    if (!specialEducationFund) {
...
/**
 * Bulk create Special Education Fund Breakdowns
 */
export const bulkCreateBreakdowns = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const breakdownIds: Id<"specialEducationFundBreakdowns">[] = [];
...
/**
 * Update a Special Education Fund Breakdown
 */
export const updateBreakdown = mutation({
  args: {
    id: v.id("specialEducationFundBreakdowns"),
