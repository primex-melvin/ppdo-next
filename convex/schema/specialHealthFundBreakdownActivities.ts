/**
 * Special Health Fund Breakdown Activities Schema
 *
 * Activity log for all Special Health Fund Breakdown operations.
 * Tracks create, update, delete, and restore actions with comprehensive change tracking.
 *
 * @module convex/schema/specialHealthFundBreakdownActivities
 */

import { defineTable } from "convex/server";
import { v } from "convex/values";

export const specialHealthFundBreakdownActivityTables = {
    specialHealthFundBreakdownActivities: defineTable({
        // ============================================================================
        // ACTION TYPE
        // ============================================================================
        action: v.union(
         ...
         */
        breakdownId: v.optional(v.id("specialHealthFundBreakdowns")),

        /**
         * Parent Special Health Fund reference (snapshot)
         */
        ...
        // Composite: special health fund + timestamp (for fund-level activity)
        .index("specialHealthFundIdAndTimestamp", ["specialHealthFundId", "timestamp"]),
};
