// convex/schema/specialEducationFunds.ts

import { defineTable } from "convex/server";
import { v } from "convex/values";

export const specialEducationFundTables = {
  /**
   * Special Education Funds Management
   * Tracks fund allocation, utilization, and project status for special education funds
   */
  specialEducationFunds: defineTable({
    /**
    ...
    /**
     * Project Status
     * Tracks the current state of the special education fund project
     */
    status: v.optional(
      v.union(
