/**
 * Special Education Fund Breakdown Activities Schema
 *
 * Activity log for all Special Education Fund Breakdown operations.
 * Tracks create, update, delete, and restore actions with comprehensive change tracking.
 *
 * @module convex/schema/specialEducationFundBreakdownActivities
 */

import { defineTable } from "convex/server";
import { v } from "convex/values";

export const specialEducationFundBreakdownActivityTables = {
  specialEducationFundBreakdownActivities: defineTable({
    // ============================================================================
    // ACTION TYPE
    // ============================================================================
    action: v.union(
     ...
     */
    breakdownId: v.optional(v.id("specialEducationFundBreakdowns")),

    /**
     * Parent Special Education Fund reference (snapshot)
     */
    ...
    // Query by special education fund
    ...
    // Composite: special education fund + timestamp (for fund-level activity)
    .index("specialEducationFundIdAndTimestamp", ["specialEducationFundId", "timestamp"]),
};
