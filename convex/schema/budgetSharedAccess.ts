// convex/schema/budgetSharedAccess.ts

import { defineTable } from "convex/server";
import { v } from "convex/values";

export const budgetSharedAccessTables = {
  /**
   * Budget Shared Access.
   * Tracks which users have been granted access to the budget page.
   */
  budgetSharedAccess: defineTable({
    /**
