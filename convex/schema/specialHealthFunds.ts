// convex/schema/specialHealthFunds.ts

import { defineTable } from "convex/server";
import { v } from "convex/values";

export const specialHealthFundTables = {
    /**
     * Special Health Funds Management
     * Tracks fund allocation, utilization, and project status for special health funds
     */
    specialHealthFunds: defineTable({
        /**
        ...
        /**
         * Date when the special health fund was received
         */
        ...
        balance: v.number(), // Remaining balance (manually calculated)

        /**
         * Utilization rate (manually calculated)
