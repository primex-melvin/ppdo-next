// convex/schema/twentyPercentDFSharedAccess.ts
import { defineTable } from "convex/server";
import { v } from "convex/values";

export const twentyPercentDFSharedAccessTables = {
    /**
     * 20% DF Shared Access
     * Tracks which users have been granted access to the 20% DF page or specific records
     */
    twentyPercentDFSharedAccess: defineTable({
        /**
