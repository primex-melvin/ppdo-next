/**
 * Trust Fund Breakdowns API
 *
 * CRUD operations for Trust Fund breakdown records.
 ...
 *
 * @module convex/trustFundBreakdowns
 */
...
/**
 * Get a single Trust Fund Breakdown by ID
 */
export const getBreakdown = query({
  args: { id: v.id("trustFundBreakdowns") },
...
/**
 * Get all active Trust Fund Breakdowns for a specific Trust Fund
 */
...
/**
 * Get breakdown statistics for a Trust Fund
 */
...
export const getTrash = query({
  ...
  handler: async (ctx, args) => {
    ...
    // Filter by trust fund if specified
    if (args.trustFundId) {
      return trashed.filter((b) => b.trustFundId === args.trustFundId);
    }
...
/**
 * Create a new Trust Fund Breakdown
 */
export const createBreakdown = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const breakdownId = await ctx.db.insert("trustFundBreakdowns", {
...
/**
 * Bulk create Trust Fund Breakdowns
 */
export const bulkCreateBreakdowns = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const breakdownIds: Id<"trustFundBreakdowns">[] = [];
...
export const restoreFromTrash = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Restore
    await restoreBreakdown(ctx, "trustFundBreakdowns", args.id, userId);
